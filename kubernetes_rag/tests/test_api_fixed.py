"""Fixed comprehensive test suite for API module to achieve 100% coverage."""
...
class TestAPIEdgeCases:
    ...
    def test_query_with_special_characters(self):
        ...
        with patch('src.generation.llm.create_rag_generator') as mock_create_generator:
            ...
            assert response.status_code == 200
            data = response.json()
            assert "special chars" in data["answer"]
    ...
    def test_search_with_unicode_query(self):
        ...
        with patch('src.retrieval.retriever.create_retriever') as mock_create_retriever:
            ...
            data = response.json()
            assert len(data["results"]) == 1
            assert "你好世界" in data["results"][0]["content"]
...
class TestAPIPerformance:
    """Test performance scenarios for API module."""
    ...
    def test_large_payload_handling(self):
        ...
        with patch('src.generation.llm.create_rag_generator') as mock_create_generator:
            ...
            long_query = "What is Kubernetes? " * 1000
